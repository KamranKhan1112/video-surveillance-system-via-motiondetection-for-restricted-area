...
message = client.messages.create( to =info_dict['your_num'], from_ = info_dict['trial_num'], body= "Alert:An intruder Detected"
                                                                                                   "Go to the following links to check the footages"
                                                                                                   "www.dropbox.com/user1101")